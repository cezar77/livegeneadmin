 ...
 */
final class Version20181029191258 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__expenditure AS SELECT id, ilri_code, name, home_program, start_date, report_date, total_budget, amount, end_date FROM expenditure');
        $this->addSql('DROP TABLE expenditure');
        $this->addSql('CREATE TABLE expenditure (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ilri_code VARCHAR(20) NOT NULL COLLATE BINARY, home_program VARCHAR(20) NOT NULL COLLATE BINARY, start_date DATE NOT NULL, report_date DATETIME NOT NULL, total_budget INTEGER DEFAULT NULL, amount INTEGER DEFAULT NULL, end_date DATE DEFAULT NULL, name VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO expenditure (id, ilri_code, name, home_program, start_date, report_date, total_budget, amount, end_date) SELECT id, ilri_code, name, home_program, start_date, report_date, total_budget, amount, end_date FROM __temp__expenditure');
        $this->addSql('DROP TABLE __temp__expenditure');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_D05A018E166D1F9C ON country_role (project_id)');
        $this->addSql('CREATE INDEX IDX_D05A018EF92F3E70 ON country_role (country_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__expenditure AS SELECT id, ilri_code, name, home_program, start_date, end_date, report_date, total_budget, amount FROM expenditure');
        $this->addSql('DROP TABLE expenditure');
        $this->addSql('CREATE TABLE expenditure (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ilri_code VARCHAR(20) NOT NULL, home_program VARCHAR(20) NOT NULL, start_date DATE NOT NULL, end_date DATE DEFAULT NULL, report_date DATETIME NOT NULL, total_budget INTEGER DEFAULT NULL, amount INTEGER DEFAULT NULL, name VARCHAR(200) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO expenditure (id, ilri_code, name, home_program, start_date, end_date, report_date, total_budget, amount) SELECT id, ilri_code, name, home_program, start_date, end_date, report_date, total_budget, amount FROM __temp__expenditure');
        $this->addSql('DROP TABLE __temp__expenditure');
        $this->addSql('DROP INDEX UNIQ_C560D76192FC23A8');
        $this->addSql('DROP INDEX UNIQ_C560D761A0D96FBF');
        $this->addSql('DROP INDEX UNIQ_C560D761C05FB297');
