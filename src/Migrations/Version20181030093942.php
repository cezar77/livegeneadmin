 ...
 */
final class Version20181030093942 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__project AS SELECT id, principal_investigator_id, ilri_code, full_name, short_name, projects_group, donor_reference, start_date, end_date, status, capacity_development, total_project_value, total_ilri_value, total_livegene_value, donor_project_name FROM project');
        $this->addSql('DROP TABLE project');
        $this->addSql('CREATE TABLE project (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, principal_investigator_id INTEGER NOT NULL, ilri_code VARCHAR(20) NOT NULL COLLATE BINARY, full_name VARCHAR(200) NOT NULL COLLATE BINARY, short_name VARCHAR(50) NOT NULL COLLATE BINARY, projects_group VARCHAR(20) NOT NULL COLLATE BINARY, donor_reference VARCHAR(50) DEFAULT NULL COLLATE BINARY, start_date DATE NOT NULL, end_date DATE NOT NULL, status INTEGER NOT NULL, capacity_development INTEGER NOT NULL, total_project_value INTEGER DEFAULT NULL, total_ilri_value INTEGER DEFAULT NULL, total_livegene_value INTEGER DEFAULT NULL, donor_project_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_2FB3D0EE5BD1A144 FOREIGN KEY (principal_investigator_id) REFERENCES staff (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO project (id, principal_investigator_id, ilri_code, full_name, short_name, projects_group, donor_reference, start_date, end_date, status, capacity_development, total_project_value, total_ilri_value, total_livegene_value, donor_project_name) SELECT id, principal_investigator_id, ilri_code, full_name, short_name, projects_group, donor_reference, start_date, end_date, status, capacity_development, total_project_value, total_ilri_value, total_livegene_value, donor_project_name FROM __temp__project');
