 ...
 */
final class Version20181029085516 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE staff (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(15) NOT NULL COLLATE BINARY, first_name VARCHAR(30) NOT NULL COLLATE BINARY, last_name VARCHAR(50) NOT NULL COLLATE BINARY, home_program VARCHAR(30) NOT NULL COLLATE BINARY, email VARCHAR(100) NOT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__staff AS SELECT id, username, first_name, last_name, home_program, email FROM staff');
        $this->addSql('DROP TABLE staff');
        $this->addSql('CREATE TABLE staff (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(15) NOT NULL, first_name VARCHAR(30) NOT NULL, last_name VARCHAR(50) NOT NULL, home_program VARCHAR(30) NOT NULL, email VARCHAR(100) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO staff (id, username, first_name, last_name, home_program, email) SELECT id, username, first_name, last_name, home_program, email FROM __temp__staff');
        $this->addSql('DROP TABLE __temp__staff');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_426EF392F85E0677 ON staff (username)');
        $this->addSql('DROP INDEX IDX_B55FFCE5166D1F9C');
