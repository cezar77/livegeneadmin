 ...
 */
final class Version20181011135516 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO sampling_activity (id, project_id, partner_id, description, start_date, end_date) SELECT id, project_id, partnership_id, description, start_date, end_date FROM __temp__sampling_activity');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE sampling_activity');
        $this->addSql('CREATE TABLE sampling_activity (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, project_id INTEGER NOT NULL, description VARCHAR(200) NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, partnership_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO sampling_activity (id, project_id, partnership_id, description, start_date, end_date) SELECT id, project_id, partner_id, description, start_date, end_date FROM __temp__sampling_activity');
        $this->addSql('DROP TABLE __temp__sampling_activity');
        $this->addSql('CREATE INDEX IDX_49213369166D1F9C ON sampling_activity (project_id)');
