 ...
 */
final class Version20190205133041 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__project AS SELECT id, principal_investigator_id, donor_id, ilri_code, full_name, short_name, donor_reference, donor_project_name, total_project_value, total_ilri_value, total_livegene_value, start_date, end_date, status, capacity_development, team FROM project');
        $this->addSql('DROP TABLE project');
        $this->addSql('CREATE TABLE project (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, principal_investigator_id INTEGER NOT NULL, donor_id INTEGER DEFAULT NULL, ilri_code VARCHAR(20) NOT NULL COLLATE BINARY, full_name VARCHAR(200) NOT NULL COLLATE BINARY, short_name VARCHAR(50) NOT NULL COLLATE BINARY, donor_reference VARCHAR(50) DEFAULT NULL COLLATE BINARY, donor_project_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, total_project_value INTEGER DEFAULT NULL, total_ilri_value INTEGER DEFAULT NULL, total_livegene_value INTEGER DEFAULT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, status INTEGER NOT NULL, capacity_development INTEGER NOT NULL, team VARCHAR(20) NOT NULL COLLATE BINARY, CONSTRAINT FK_2FB3D0EE5BD1A144 FOREIGN KEY (principal_investigator_id) REFERENCES staff (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2FB3D0EE3DD7B7A7 FOREIGN KEY (donor_id) REFERENCES organisation (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO project (id, principal_investigator_id, donor_id, ilri_code, full_name, short_name, donor_reference, donor_project_name, total_project_value, total_ilri_value, total_livegene_value, start_date, end_date, status, capacity_development, team) SELECT id, principal_investigator_id, donor_id, ilri_code, full_name, short_name, donor_reference, donor_project_name, total_project_value, total_ilri_value, total_livegene_value, start_date, end_date, status, capacity_development, team FROM __temp__project');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__sampling_activity AS SELECT id, project_id, owner_id, description, start_date, end_date FROM sampling_activity');
        $this->addSql('DROP TABLE sampling_activity');
        $this->addSql('CREATE TABLE sampling_activity (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, project_id INTEGER NOT NULL, owner_id INTEGER NOT NULL, description VARCHAR(200) NOT NULL COLLATE BINARY, start_date DATE NOT NULL, end_date DATE NOT NULL, CONSTRAINT FK_49213369166D1F9C FOREIGN KEY (project_id) REFERENCES project (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_492133697E3C61F9 FOREIGN KEY (owner_id) REFERENCES fos_user_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO sampling_activity (id, project_id, owner_id, description, start_date, end_date) SELECT id, project_id, owner_id, description, start_date, end_date FROM __temp__sampling_activity');
        ...
        $this->addSql('DROP INDEX IDX_73D61822994540B8');
        $this->addSql('DROP INDEX IDX_73D618229E6B1585');
        $this->addSql('CREATE TEMPORARY TABLE __temp__sampling_activity_organisation AS SELECT sampling_activity_id, organisation_id FROM sampling_activity_organisation');
        $this->addSql('DROP TABLE sampling_activity_organisation');
        $this->addSql('CREATE TABLE sampling_activity_organisation (sampling_activity_id INTEGER NOT NULL, organisation_id INTEGER NOT NULL, PRIMARY KEY(sampling_activity_id, organisation_id), CONSTRAINT FK_73D61822994540B8 FOREIGN KEY (sampling_activity_id) REFERENCES sampling_activity (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_73D618229E6B1585 FOREIGN KEY (organisation_id) REFERENCES organisation (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO sampling_activity_organisation (sampling_activity_id, organisation_id) SELECT sampling_activity_id, organisation_id FROM __temp__sampling_activity_organisation');
        $this->addSql('DROP TABLE __temp__sampling_activity_organisation');
        $this->addSql('CREATE INDEX IDX_73D61822994540B8 ON sampling_activity_organisation (sampling_activity_id)');
        $this->addSql('CREATE INDEX IDX_73D618229E6B1585 ON sampling_activity_organisation (organisation_id)');
        $this->addSql('DROP INDEX IDX_1E7BFE9B994540B8');
        $this->addSql('DROP INDEX IDX_1E7BFE9BB2A1D860');
        $this->addSql('CREATE TEMPORARY TABLE __temp__sampling_activity_species AS SELECT sampling_activity_id, species_id FROM sampling_activity_species');
        $this->addSql('DROP TABLE sampling_activity_species');
        $this->addSql('CREATE TABLE sampling_activity_species (sampling_activity_id INTEGER NOT NULL, species_id INTEGER NOT NULL, PRIMARY KEY(sampling_activity_id, species_id), CONSTRAINT FK_1E7BFE9B994540B8 FOREIGN KEY (sampling_activity_id) REFERENCES sampling_activity (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_1E7BFE9BB2A1D860 FOREIGN KEY (species_id) REFERENCES species (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO sampling_activity_species (sampling_activity_id, species_id) SELECT sampling_activity_id, species_id FROM __temp__sampling_activity_species');
        $this->addSql('DROP TABLE __temp__sampling_activity_species');
        $this->addSql('CREATE INDEX IDX_1E7BFE9B994540B8 ON sampling_activity_species (sampling_activity_id)');
        $this->addSql('CREATE INDEX IDX_1E7BFE9BB2A1D860 ON sampling_activity_species (species_id)');
        $this->addSql('DROP INDEX IDX_E807C0EF994540B8');
        $this->addSql('DROP INDEX IDX_E807C0EFF92F3E70');
        $this->addSql('CREATE TEMPORARY TABLE __temp__sampling_activity_country AS SELECT sampling_activity_id, country_id FROM sampling_activity_country');
        $this->addSql('DROP TABLE sampling_activity_country');
        $this->addSql('CREATE TABLE sampling_activity_country (sampling_activity_id INTEGER NOT NULL, country_id INTEGER NOT NULL, PRIMARY KEY(sampling_activity_id, country_id), CONSTRAINT FK_E807C0EF994540B8 FOREIGN KEY (sampling_activity_id) REFERENCES sampling_activity (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_E807C0EFF92F3E70 FOREIGN KEY (country_id) REFERENCES country (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO sampling_activity_country (sampling_activity_id, country_id) SELECT sampling_activity_id, country_id FROM __temp__sampling_activity_country');
        $this->addSql('DROP TABLE __temp__sampling_activity_country');
        $this->addSql('CREATE INDEX IDX_E807C0EF994540B8 ON sampling_activity_country (sampling_activity_id)');
        $this->addSql('CREATE INDEX IDX_E807C0EFF92F3E70 ON sampling_activity_country (country_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__organisation AS SELECT id, country_id, short_name, full_name, logo_url, local_name, url FROM organisation');
        $this->addSql('DROP TABLE organisation');
        $this->addSql('CREATE TABLE organisation (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, country_id INTEGER NOT NULL, short_name VARCHAR(20) DEFAULT NULL COLLATE BINARY, full_name VARCHAR(200) NOT NULL COLLATE BINARY, logo_url VARCHAR(255) NOT NULL COLLATE BINARY, local_name VARCHAR(200) DEFAULT NULL COLLATE BINARY, url VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_E6E132B4F92F3E70 FOREIGN KEY (country_id) REFERENCES country (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO organisation (id, country_id, short_name, full_name, logo_url, local_name, url) SELECT id, country_id, short_name, full_name, logo_url, local_name, url FROM __temp__organisation');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE __temp__media__media');
        $this->addSql('DROP INDEX IDX_E6E132B4F92F3E70');
        $this->addSql('CREATE TEMPORARY TABLE __temp__organisation AS SELECT id, country_id, short_name, full_name, local_name, url, logo_url FROM organisation');
        $this->addSql('DROP TABLE organisation');
        $this->addSql('CREATE TABLE organisation (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, country_id INTEGER NOT NULL, short_name VARCHAR(20) DEFAULT NULL, full_name VARCHAR(200) NOT NULL, local_name VARCHAR(200) DEFAULT NULL, url VARCHAR(255) DEFAULT NULL, logo_url VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO organisation (id, country_id, short_name, full_name, local_name, url, logo_url) SELECT id, country_id, short_name, full_name, local_name, url, logo_url FROM __temp__organisation');
        $this->addSql('DROP TABLE __temp__organisation');
        $this->addSql('CREATE INDEX IDX_E6E132B4F92F3E70 ON organisation (country_id)');
        $this->addSql('DROP INDEX IDX_8619D6AE166D1F9C');
        $this->addSql('DROP INDEX IDX_8619D6AE9393F8FE');
        ...
        $this->addSql('DROP TABLE project');
        $this->addSql('CREATE TABLE project (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, principal_investigator_id INTEGER NOT NULL, donor_id INTEGER DEFAULT NULL, ilri_code VARCHAR(20) NOT NULL, full_name VARCHAR(200) NOT NULL, short_name VARCHAR(50) NOT NULL, team VARCHAR(20) NOT NULL, donor_reference VARCHAR(50) DEFAULT NULL, donor_project_name VARCHAR(255) DEFAULT NULL, total_project_value INTEGER DEFAULT NULL, total_ilri_value INTEGER DEFAULT NULL, total_livegene_value INTEGER DEFAULT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, status INTEGER NOT NULL, capacity_development INTEGER NOT NULL)');
        $this->addSql('INSERT INTO project (id, principal_investigator_id, donor_id, ilri_code, full_name, short_name, team, donor_reference, donor_project_name, total_project_value, total_ilri_value, total_livegene_value, start_date, end_date, status, capacity_development) SELECT id, principal_investigator_id, donor_id, ilri_code, full_name, short_name, team, donor_reference, donor_project_name, total_project_value, total_ilri_value, total_livegene_value, start_date, end_date, status, capacity_development FROM __temp__project');
        $this->addSql('DROP TABLE __temp__project');
        $this->addSql('CREATE INDEX IDX_2FB3D0EE5BD1A144 ON project (principal_investigator_id)');
        $this->addSql('CREATE INDEX IDX_2FB3D0EE3DD7B7A7 ON project (donor_id)');
        $this->addSql('DROP INDEX IDX_49213369166D1F9C');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__sampling_activity AS SELECT id, project_id, owner_id, description, start_date, end_date FROM sampling_activity');
        $this->addSql('DROP TABLE sampling_activity');
        $this->addSql('CREATE TABLE sampling_activity (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, project_id INTEGER NOT NULL, owner_id INTEGER NOT NULL, description VARCHAR(200) NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL)');
        $this->addSql('INSERT INTO sampling_activity (id, project_id, owner_id, description, start_date, end_date) SELECT id, project_id, owner_id, description, start_date, end_date FROM __temp__sampling_activity');
        $this->addSql('DROP TABLE __temp__sampling_activity');
        $this->addSql('CREATE INDEX IDX_49213369166D1F9C ON sampling_activity (project_id)');
        $this->addSql('CREATE INDEX IDX_492133697E3C61F9 ON sampling_activity (owner_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__sampling_activity_country AS SELECT sampling_activity_id, country_id FROM sampling_activity_country');
        $this->addSql('DROP TABLE sampling_activity_country');
        $this->addSql('CREATE TABLE sampling_activity_country (sampling_activity_id INTEGER NOT NULL, country_id INTEGER NOT NULL, PRIMARY KEY(sampling_activity_id, country_id))');
        $this->addSql('INSERT INTO sampling_activity_country (sampling_activity_id, country_id) SELECT sampling_activity_id, country_id FROM __temp__sampling_activity_country');
        $this->addSql('DROP TABLE __temp__sampling_activity_country');
        $this->addSql('CREATE INDEX IDX_E807C0EF994540B8 ON sampling_activity_country (sampling_activity_id)');
        $this->addSql('CREATE INDEX IDX_E807C0EFF92F3E70 ON sampling_activity_country (country_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__sampling_activity_organisation AS SELECT sampling_activity_id, organisation_id FROM sampling_activity_organisation');
        $this->addSql('DROP TABLE sampling_activity_organisation');
        $this->addSql('CREATE TABLE sampling_activity_organisation (sampling_activity_id INTEGER NOT NULL, organisation_id INTEGER NOT NULL, PRIMARY KEY(sampling_activity_id, organisation_id))');
        $this->addSql('INSERT INTO sampling_activity_organisation (sampling_activity_id, organisation_id) SELECT sampling_activity_id, organisation_id FROM __temp__sampling_activity_organisation');
        $this->addSql('DROP TABLE __temp__sampling_activity_organisation');
        $this->addSql('CREATE INDEX IDX_73D61822994540B8 ON sampling_activity_organisation (sampling_activity_id)');
        $this->addSql('CREATE INDEX IDX_73D618229E6B1585 ON sampling_activity_organisation (organisation_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__sampling_activity_species AS SELECT sampling_activity_id, species_id FROM sampling_activity_species');
        $this->addSql('DROP TABLE sampling_activity_species');
        $this->addSql('CREATE TABLE sampling_activity_species (sampling_activity_id INTEGER NOT NULL, species_id INTEGER NOT NULL, PRIMARY KEY(sampling_activity_id, species_id))');
        $this->addSql('INSERT INTO sampling_activity_species (sampling_activity_id, species_id) SELECT sampling_activity_id, species_id FROM __temp__sampling_activity_species');
        $this->addSql('DROP TABLE __temp__sampling_activity_species');
        $this->addSql('CREATE INDEX IDX_1E7BFE9B994540B8 ON sampling_activity_species (sampling_activity_id)');
        $this->addSql('CREATE INDEX IDX_1E7BFE9BB2A1D860 ON sampling_activity_species (species_id)');
