 ...
 */
final class Version20181002090524 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE staff (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(15) NOT NULL COLLATE BINARY, first_name VARCHAR(30) NOT NULL COLLATE BINARY, last_name VARCHAR(50) NOT NULL COLLATE BINARY, home_program VARCHAR(30) NOT NULL COLLATE BINARY, email VARCHAR(100) NOT NULL COLLATE BINARY)');
