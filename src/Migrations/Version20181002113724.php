 ...
 */
final class Version20181002113724 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__partnership AS SELECT id, project_id, partner_id, start_date, end_date FROM partnership');
        $this->addSql('DROP TABLE partnership');
        $this->addSql('CREATE TABLE partnership (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, project_id INTEGER NOT NULL, partner_id INTEGER NOT NULL, start_date DATE DEFAULT NULL, end_date DATE DEFAULT NULL, CONSTRAINT FK_8619D6AE166D1F9C FOREIGN KEY (project_id) REFERENCES project (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_8619D6AE9393F8FE FOREIGN KEY (partner_id) REFERENCES organisation (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO partnership (id, project_id, partner_id, start_date, end_date) SELECT id, project_id, partner_id, start_date, end_date FROM __temp__partnership');
        ...
        $this->addSql('CREATE TABLE expenditure (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ilri_code VARCHAR(20) NOT NULL COLLATE BINARY, name VARCHAR(200) NOT NULL COLLATE BINARY, home_program VARCHAR(20) NOT NULL COLLATE BINARY, start_date DATE NOT NULL, report_date DATETIME NOT NULL, total_budget INTEGER DEFAULT NULL, amount INTEGER DEFAULT NULL, end_date DATE DEFAULT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__expenditure AS SELECT id, ilri_code, name, home_program, start_date, end_date, report_date, total_budget, amount FROM expenditure');
        $this->addSql('DROP TABLE expenditure');
        $this->addSql('CREATE TABLE expenditure (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ilri_code VARCHAR(20) NOT NULL, name VARCHAR(200) NOT NULL, home_program VARCHAR(20) NOT NULL, start_date DATE NOT NULL, report_date DATETIME NOT NULL, total_budget INTEGER DEFAULT NULL, amount INTEGER DEFAULT NULL, end_date DATE NOT NULL)');
        $this->addSql('INSERT INTO expenditure (id, ilri_code, name, home_program, start_date, end_date, report_date, total_budget, amount) SELECT id, ilri_code, name, home_program, start_date, end_date, report_date, total_budget, amount FROM __temp__expenditure');
        $this->addSql('DROP TABLE __temp__expenditure');
        $this->addSql('DROP INDEX IDX_E6E132B4F92F3E70');
        $this->addSql('CREATE TEMPORARY TABLE __temp__organisation AS SELECT id, country_id, short_name, full_name, logo_url FROM organisation');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__partnership AS SELECT id, project_id, partner_id, start_date, end_date FROM partnership');
        $this->addSql('DROP TABLE partnership');
        $this->addSql('CREATE TABLE partnership (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, project_id INTEGER NOT NULL, partner_id INTEGER NOT NULL, start_date DATE DEFAULT NULL, end_date DATE DEFAULT NULL)');
        $this->addSql('INSERT INTO partnership (id, project_id, partner_id, start_date, end_date) SELECT id, project_id, partner_id, start_date, end_date FROM __temp__partnership');
        $this->addSql('DROP TABLE __temp__partnership');
        $this->addSql('CREATE INDEX IDX_8619D6AE166D1F9C ON partnership (project_id)');
        $this->addSql('CREATE INDEX IDX_8619D6AE9393F8FE ON partnership (partner_id)');
