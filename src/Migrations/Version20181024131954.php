 ...
 */
final class Version20181024131954 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__project AS SELECT id, principal_investigator_id, ilri_code, full_name, short_name, projects_group, donor_reference, donor_project_name, start_date, end_date, status, capacity_development, total_project_value, total_ilri_value, total_livegene_value FROM project');
        $this->addSql('DROP TABLE project');
        $this->addSql('CREATE TABLE project (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, principal_investigator_id INTEGER NOT NULL, ilri_code VARCHAR(20) NOT NULL COLLATE BINARY, full_name VARCHAR(200) NOT NULL COLLATE BINARY, short_name VARCHAR(50) NOT NULL COLLATE BINARY, projects_group VARCHAR(20) NOT NULL COLLATE BINARY, donor_reference VARCHAR(50) DEFAULT NULL COLLATE BINARY, donor_project_name VARCHAR(200) DEFAULT NULL COLLATE BINARY, start_date DATE NOT NULL, end_date DATE NOT NULL, status INTEGER NOT NULL, capacity_development INTEGER NOT NULL, total_project_value INTEGER DEFAULT NULL, total_ilri_value INTEGER DEFAULT NULL, total_livegene_value INTEGER DEFAULT NULL, CONSTRAINT FK_2FB3D0EE5BD1A144 FOREIGN KEY (principal_investigator_id) REFERENCES staff (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO project (id, principal_investigator_id, ilri_code, full_name, short_name, projects_group, donor_reference, donor_project_name, start_date, end_date, status, capacity_development, total_project_value, total_ilri_value, total_livegene_value) SELECT id, principal_investigator_id, ilri_code, full_name, short_name, projects_group, donor_reference, donor_project_name, start_date, end_date, status, capacity_development, total_project_value, total_ilri_value, total_livegene_value FROM __temp__project');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__sampling_activity AS SELECT id, project_id, partner_id, description, start_date, end_date FROM sampling_activity');
        $this->addSql('DROP TABLE sampling_activity');
        $this->addSql('CREATE TABLE sampling_activity (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, project_id INTEGER NOT NULL, partner_id INTEGER NOT NULL, description VARCHAR(200) NOT NULL COLLATE BINARY, start_date DATE NOT NULL, end_date DATE NOT NULL, CONSTRAINT FK_49213369166D1F9C FOREIGN KEY (project_id) REFERENCES project (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_492133699393F8FE FOREIGN KEY (partner_id) REFERENCES organisation (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO sampling_activity (id, project_id, partner_id, description, start_date, end_date) SELECT id, project_id, partner_id, description, start_date, end_date FROM __temp__sampling_activity');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__sampling_documentation AS SELECT id, sampling_activity_id, sampling_document_type_id, document_id FROM sampling_documentation');
        ...
        $this->addSql('INSERT INTO sampling_documentation (id, sampling_activity_id, sampling_document_type_id, document_id) SELECT id, sampling_activity_id, sampling_document_type_id, document_id FROM __temp__sampling_documentation');
        ...
        $this->addSql('DROP INDEX UNIQ_426EF392F85E0677');
        $this->addSql('CREATE TEMPORARY TABLE __temp__staff AS SELECT id, username, first_name, last_name, home_program, email FROM staff');
        $this->addSql('DROP TABLE staff');
        $this->addSql('CREATE TABLE staff (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(15) NOT NULL COLLATE BINARY, first_name VARCHAR(30) NOT NULL COLLATE BINARY, last_name VARCHAR(50) NOT NULL COLLATE BINARY, home_program VARCHAR(30) NOT NULL COLLATE BINARY, email VARCHAR(100) DEFAULT NULL)');
        $this->addSql('INSERT INTO staff (id, username, first_name, last_name, home_program, email) SELECT id, username, first_name, last_name, home_program, email FROM __temp__staff');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_5581D2E5E7A1254A ON partnership_contact (contact_id)');
        $this->addSql('DROP INDEX IDX_2FB3D0EE5BD1A144');
        $this->addSql('CREATE TEMPORARY TABLE __temp__project AS SELECT id, principal_investigator_id, ilri_code, full_name, short_name, projects_group, donor_reference, donor_project_name, total_project_value, total_ilri_value, total_livegene_value, start_date, end_date, status, capacity_development FROM project');
        $this->addSql('DROP TABLE project');
        $this->addSql('CREATE TABLE project (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, principal_investigator_id INTEGER NOT NULL, ilri_code VARCHAR(20) NOT NULL, full_name VARCHAR(200) NOT NULL, short_name VARCHAR(50) NOT NULL, projects_group VARCHAR(20) NOT NULL, donor_reference VARCHAR(50) DEFAULT NULL, donor_project_name VARCHAR(200) DEFAULT NULL, total_project_value INTEGER DEFAULT NULL, total_ilri_value INTEGER DEFAULT NULL, total_livegene_value INTEGER DEFAULT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, status INTEGER NOT NULL, capacity_development INTEGER NOT NULL)');
        $this->addSql('INSERT INTO project (id, principal_investigator_id, ilri_code, full_name, short_name, projects_group, donor_reference, donor_project_name, total_project_value, total_ilri_value, total_livegene_value, start_date, end_date, status, capacity_development) SELECT id, principal_investigator_id, ilri_code, full_name, short_name, projects_group, donor_reference, donor_project_name, total_project_value, total_ilri_value, total_livegene_value, start_date, end_date, status, capacity_development FROM __temp__project');
        $this->addSql('DROP TABLE __temp__project');
        $this->addSql('CREATE INDEX IDX_2FB3D0EE5BD1A144 ON project (principal_investigator_id)');
        $this->addSql('DROP INDEX IDX_49213369166D1F9C');
        $this->addSql('DROP INDEX IDX_492133699393F8FE');
        $this->addSql('CREATE TEMPORARY TABLE __temp__sampling_activity AS SELECT id, project_id, partner_id, description, start_date, end_date FROM sampling_activity');
        $this->addSql('DROP TABLE sampling_activity');
        $this->addSql('CREATE TABLE sampling_activity (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, project_id INTEGER NOT NULL, partner_id INTEGER NOT NULL, description VARCHAR(200) NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL)');
        $this->addSql('INSERT INTO sampling_activity (id, project_id, partner_id, description, start_date, end_date) SELECT id, project_id, partner_id, description, start_date, end_date FROM __temp__sampling_activity');
        $this->addSql('DROP TABLE __temp__sampling_activity');
        $this->addSql('CREATE INDEX IDX_49213369166D1F9C ON sampling_activity (project_id)');
        $this->addSql('CREATE INDEX IDX_492133699393F8FE ON sampling_activity (partner_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__sampling_documentation AS SELECT id, sampling_activity_id, sampling_document_type_id, document_id FROM sampling_documentation');
        $this->addSql('DROP TABLE sampling_documentation');
        $this->addSql('CREATE TABLE sampling_documentation (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, sampling_activity_id INTEGER NOT NULL, sampling_document_type_id INTEGER NOT NULL, document_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO sampling_documentation (id, sampling_activity_id, sampling_document_type_id, document_id) SELECT id, sampling_activity_id, sampling_document_type_id, document_id FROM __temp__sampling_documentation');
        $this->addSql('DROP TABLE __temp__sampling_documentation');
        $this->addSql('CREATE INDEX IDX_43BC985A994540B8 ON sampling_documentation (sampling_activity_id)');
        $this->addSql('CREATE INDEX IDX_43BC985ADA055526 ON sampling_documentation (sampling_document_type_id)');
        ...
        $this->addSql('CREATE INDEX IDX_8EB6A6AF6F37DCD9 ON sdgrole (sdg_id)');
        $this->addSql('DROP INDEX UNIQ_426EF392F85E0677');
        $this->addSql('CREATE TEMPORARY TABLE __temp__staff AS SELECT id, username, home_program, first_name, last_name, email FROM staff');
        $this->addSql('DROP TABLE staff');
        $this->addSql('CREATE TABLE staff (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(15) NOT NULL, home_program VARCHAR(30) NOT NULL, first_name VARCHAR(30) NOT NULL, last_name VARCHAR(50) NOT NULL, email VARCHAR(100) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO staff (id, username, home_program, first_name, last_name, email) SELECT id, username, home_program, first_name, last_name, email FROM __temp__staff');
        $this->addSql('DROP TABLE __temp__staff');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_426EF392F85E0677 ON staff (username)');
        $this->addSql('DROP INDEX IDX_B55FFCE5166D1F9C');
        $this->addSql('DROP INDEX IDX_B55FFCE5217BBB47');
