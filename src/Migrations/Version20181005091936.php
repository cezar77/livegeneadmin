 ...
 */
final class Version20181005091936 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__partnership_type AS SELECT id, description FROM partnership_type');
        $this->addSql('DROP TABLE partnership_type');
        $this->addSql('CREATE TABLE partnership_type (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, description VARCHAR(30) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO partnership_type (id, description) SELECT id, description FROM __temp__partnership_type');
        $this->addSql('DROP TABLE __temp__partnership_type');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_63FD47B26DE44026 ON partnership_type (description)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_5581D2E56AE7F85 ON partnership_contact (partnership_id)');
        $this->addSql('CREATE INDEX IDX_5581D2E5E7A1254A ON partnership_contact (contact_id)');
        $this->addSql('DROP INDEX UNIQ_63FD47B26DE44026');
        $this->addSql('CREATE TEMPORARY TABLE __temp__partnership_type AS SELECT id, description FROM partnership_type');
        $this->addSql('DROP TABLE partnership_type');
