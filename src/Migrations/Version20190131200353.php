 ...
 */
final class Version20190131200353 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE project (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, principal_investigator_id INTEGER NOT NULL, donor_id INTEGER DEFAULT NULL, ilri_code VARCHAR(20) NOT NULL COLLATE BINARY, full_name VARCHAR(200) NOT NULL COLLATE BINARY, short_name VARCHAR(50) NOT NULL COLLATE BINARY, projects_group VARCHAR(20) NOT NULL COLLATE BINARY, donor_reference VARCHAR(50) DEFAULT NULL COLLATE BINARY, donor_project_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, total_project_value INTEGER DEFAULT NULL, total_ilri_value INTEGER DEFAULT NULL, total_livegene_value INTEGER DEFAULT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, status INTEGER NOT NULL, capacity_development INTEGER NOT NULL, CONSTRAINT FK_2FB3D0EE5BD1A144 FOREIGN KEY (principal_investigator_id) REFERENCES staff (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2FB3D0EE3DD7B7A7 FOREIGN KEY (donor_id) REFERENCES organisation (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__sampling_document_type AS SELECT id, long_name, short_name FROM sampling_document_type');
        $this->addSql('DROP TABLE sampling_document_type');
        $this->addSql('CREATE TABLE sampling_document_type (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, long_name VARCHAR(100) NOT NULL COLLATE BINARY, short_name VARCHAR(30) NOT NULL)');
        $this->addSql('INSERT INTO sampling_document_type (id, long_name, short_name) SELECT id, long_name, short_name FROM __temp__sampling_document_type');
        $this->addSql('DROP TABLE __temp__sampling_document_type');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__project AS SELECT id, principal_investigator_id, ilri_code, full_name, short_name, projects_group, donor_reference, donor_project_name, total_project_value, total_ilri_value, total_livegene_value, start_date, end_date, status, capacity_development FROM project');
        $this->addSql('DROP TABLE project');
        $this->addSql('CREATE TABLE project (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, principal_investigator_id INTEGER NOT NULL, ilri_code VARCHAR(20) NOT NULL, full_name VARCHAR(200) NOT NULL, short_name VARCHAR(50) NOT NULL, projects_group VARCHAR(20) NOT NULL, donor_reference VARCHAR(50) DEFAULT NULL, donor_project_name VARCHAR(255) DEFAULT NULL, total_project_value INTEGER DEFAULT NULL, total_ilri_value INTEGER DEFAULT NULL, total_livegene_value INTEGER DEFAULT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, status INTEGER NOT NULL, capacity_development INTEGER NOT NULL)');
        $this->addSql('INSERT INTO project (id, principal_investigator_id, ilri_code, full_name, short_name, projects_group, donor_reference, donor_project_name, total_project_value, total_ilri_value, total_livegene_value, start_date, end_date, status, capacity_development) SELECT id, principal_investigator_id, ilri_code, full_name, short_name, projects_group, donor_reference, donor_project_name, total_project_value, total_ilri_value, total_livegene_value, start_date, end_date, status, capacity_development FROM __temp__project');
        $this->addSql('DROP TABLE __temp__project');
        $this->addSql('CREATE INDEX IDX_2FB3D0EE5BD1A144 ON project (principal_investigator_id)');
        $this->addSql('DROP INDEX IDX_49213369166D1F9C');
        ...
        $this->addSql('CREATE INDEX IDX_492133699393F8FE ON sampling_activity (partner_id)');
        $this->addSql('CREATE INDEX IDX_492133697E3C61F9 ON sampling_activity (owner_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__sampling_document_type AS SELECT id, short_name, long_name FROM sampling_document_type');
        $this->addSql('DROP TABLE sampling_document_type');
        $this->addSql('CREATE TABLE sampling_document_type (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, long_name VARCHAR(100) NOT NULL, short_name VARCHAR(20) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO sampling_document_type (id, short_name, long_name) SELECT id, short_name, long_name FROM __temp__sampling_document_type');
        $this->addSql('DROP TABLE __temp__sampling_document_type');
        $this->addSql('DROP INDEX IDX_43BC985A994540B8');
        $this->addSql('DROP INDEX IDX_43BC985ADA055526');
        $this->addSql('DROP INDEX IDX_43BC985AC33F7837');
