 ...
 */
final class Version20181001201801 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__country AS SELECT id, country FROM country');
        $this->addSql('DROP TABLE country');
        $this->addSql('CREATE TABLE country (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, country VARCHAR(2) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO country (id, country) SELECT id, country FROM __temp__country');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_5373C9665373C966');
        $this->addSql('CREATE TEMPORARY TABLE __temp__country AS SELECT id, country FROM country');
        $this->addSql('DROP TABLE country');
